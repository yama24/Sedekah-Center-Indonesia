...
INSERT IGNORE INTO `basis` (`basis_id`, `basis_nama`, `basis_ttl`, `basis_tempat_kerja`, `basis_gender`, `basis_pekerjaan`, `basis_provinsi`, `basis_kabupaten`, `basis_kecamatan`, `basis_desa`, `basis_phone`, `basis_email`, `basis_datainput`) VALUES
...
INSERT IGNORE INTO `links` (`links_id`, `links_tipe`, `links_nama`, `links`) VALUES
...
INSERT IGNORE INTO `linkstype` (`id`, `tipe`) VALUES
	(1, 'Whatsapp'),
	(2, 'Telegram'),
	(3, 'Lainnya');
...
INSERT IGNORE INTO `pekerjaan` (`pekerjaan_id`, `pekerjaan`) VALUES
	(4, 'Pelajar'),
	(5, 'Mahasiswa'),
	(6, 'Ibu Rumah Tangga'),
	(7, 'PNS'),
...
INSERT IGNORE INTO `pengguna` (`pengguna_id`, `pengguna_nama`, `pengguna_email`, `pengguna_username`, `pengguna_password`, `pengguna_foto`, `pengguna_level`, `pengguna_status`) VALUES
...
-- Membuang data untuk tabel sci.transaksi: ~5 rows (lebih kurang)
/*!40000 ALTER TABLE `transaksi` DISABLE KEYS */;
INSERT IGNORE INTO `transaksi` (`id`, `inv`, `reference`, `nama`, `phone`, `email`, `jumlah`, `fee`, `diterima`, `bayar`, `paid_at`, `nama_metode`, `metode`, `pay_code`, `status`, `data_input`) VALUES
